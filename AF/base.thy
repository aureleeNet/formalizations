...
(* sets and relations are vanilla predicates *)
...
(*useful set operations and shorthand:*)
...
lemma  \<open>minimal Prop Obj E \<longrightarrow>    least Prop Obj E\<close> nitpick oops
lemma  \<open>maximal Prop Obj E \<longrightarrow> greatest Prop Obj E\<close> nitpick oops
